...
const CssLessons: React.FC = () => {
  ...
  return (
    <div
      className={`w-full h-full p-4 lg:p-8 flex flex-col gap-6 lg:gap-8 bg-[#06060a] min-h-screen text-slate-200 ${config.theme.selection} font-inter overflow-y-auto overflow-x-hidden`}
    >
