      ...
      {isUploading && (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-md z-[100] flex items-center justify-center">
          <div className="bg-[#0d0d12] border border-[#2a2a3c] p-8 rounded-2xl w-[90%] max-w-sm text-center shadow-[0_0_50px_rgba(168,85,247,0.2)]">
            <h2 className="text-white font-exo text-xl font-bold tracking-tight mb-6">Transmitting Data...</h2>
            ...
            <p className="text-purple-400 font-mono mt-4 font-bold">{Math.round(uploadProgress)}%</p>
          </div>
        </div>
      )}
        ...
        {showLogoutPopUp && (
          <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-[100] flex items-center justify-center p-4">
            ...
            >
              ...
              <h2 className="text-2xl font-bold font-exo tracking-tight">Terminate Session?</h2>
              <p className="text-slate-400 mt-2 mb-8">Are you sure you want to disconnect from the DevLab mainframe?</p>
