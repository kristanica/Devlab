...
function LevelEdit({
  ...
  levelId,
  defaultData = {}
}: LevelEditProps): React.ReactElement {
  const { mutate: editLevel, isPending } = useEditLevel(category);

  // Local state for form fields
  const [state, setState] = useState<LevelEditState>({
  ...
  const handleChange = (key: keyof LevelEditState, value: string | number): void => {
