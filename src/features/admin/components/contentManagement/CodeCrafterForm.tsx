...
export interface CodeCrafterFormProps {
  ...
  replicateFile: string;
  setReplicateFile: (url: string) => void;
}

function CodeCrafterForm({
  stageData,
  state,
  dispatch,
  subject,
  ...
  replicateFile,
  setReplicateFile,
}: CodeCrafterFormProps): React.ReactElement {
