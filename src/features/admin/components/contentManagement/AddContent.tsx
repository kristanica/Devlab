...
export default function NewLessonForm({ subject, close }: AddContentProps): React.ReactElement {
  ...
  // ---------------- MUTATION LOGIC
  const createLessonMutation = useMutation<any, Error, void>({
    mutationFn: async () => {
          ...
          (lang) =>
            show(lang) && (
              <div key={lang} className="flex flex-col">
                ...
                <textarea
                  value={stageState.codingInterface[lang as keyof typeof stageState.codingInterface]}
                  onChange={(e) =>
                    setStageState((prev) => ({
                      ...prev,
