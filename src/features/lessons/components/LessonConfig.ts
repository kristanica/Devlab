...
export const lessonConfig: Record<string, any> = {
  ...
  Css: {
    ...
    header: {
      ...
      description:
        "Transform raw HTML skeletons into beautiful, responsive masterpieces. In this module, you'll master the art of styling, layout algorithms like Flexbox and Grid, and stunning animations that bring your user interfaces to life. Master the cascade and paint the web!",
    },
    about: {
      title: "The Artist's Palette",
      description:
        "CSS brings your HTML to life. You will learn to control spacing, typography, colors, and responsive layouts that adapt to any screen size. Make your applications look professional and polished.",
      checks: [
        "Responsive Design",
        "Flexbox & Grid",
  ...
  JavaScript: {
    ...
    header: {
      ...
      description:
        "Breathe life into your static pages. JavaScript is the programming language of the web, allowing you to create dynamic interactions, fetch data from APIs, and build complex single-page applications. Master variables, functions, DOM manipulation, and asynchronous programming.",
    },
    about: {
      title: "The Brains of the Operation",
      description:
        "HTML is the skeleton, CSS is the skin, but JavaScript is the muscle. Learn how to make your websites interactive, handle user events, and perform complex calculations directly in the browser.",
  ...
  Database: {
    ...
    header: {
      ...
      description:
        "Every great application needs a memory. Dive into the world of backend data persistence. You will learn how to design schemas, write SQL queries, and securely store and retrieve user data. Master the art of the CRUD operations and secure your application's vault.",
    },
    about: {
      title: "The Persistent Memory",
      description:
        "Learn how modern applications store their data securely. You'll master SQL databases, table relationships, and data normalization. Power your web applications with a robust backend architecture.",
