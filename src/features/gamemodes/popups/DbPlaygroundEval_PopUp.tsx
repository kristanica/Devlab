...
interface DbEvaluationResult {
  queryFeedback?: string;
  queryImprovement?: string;
}

function DbPlaygroundEval_Popup({ evaluationResult, setShowEvalPopup }: {evaluationResult: DbEvaluationResult; setShowEvalPopup: (val: boolean) => void}): React.ReactNode {
return (
  <>
    <motion.div
