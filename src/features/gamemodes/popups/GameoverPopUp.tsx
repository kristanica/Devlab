...
function Gameover_PopUp({ gameOver, resetHearts, Back, subject, lessonId, levelId, stageId }: {gameOver: boolean; resetHearts: () => void; Back: string; subject: string; lessonId: string; levelId: string; stageId: string}): React.ReactNode {
