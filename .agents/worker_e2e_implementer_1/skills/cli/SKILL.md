---
name: cli
description: General instructions and guidelines for Antigravity, including web app development, tools, planning mode, and communication style.
---
...
`</web_application_development>`  
... [Rest of skill description truncated for brevity, refer to original path]
